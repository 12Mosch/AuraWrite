  ...
  const handleCreateNewDocument = async () => {
    ...
    try {
      const docId = await createDocument({
        ...
        content: JSON.stringify([{type: "paragraph", children: [{text: "New test document..."}]}]),
        isPublic: false,
      });
      setTestDocumentId(docId);
    } catch (error) {
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="mb-6 p-4 bg-blue-50 rounded-lg">
          ...
          <ul className="list-disc list-inside text-blue-800 space-y-1">
            <li>Both editors below are connected to the same Convex document</li>
            <li>Type in one editor and watch the changes appear in the other</li>
            <li>Open this page in multiple browser tabs to test real-time sync</li>
        ...
        <div className="mb-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="mb-4 text-sm text-gray-600">
            <p><strong>Current Document ID:</strong> <code className="bg-gray-200 px-2 py-1 rounded">{testDocumentId}</code></p>
          </div>
          ...
          <>
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600 mb-3">
                This editor is connected to the same document. Changes should sync in real-time.
              </p>
              <ConvexCollaborativeEditor
                documentId={testDocumentId}
