...
} from "../components/CollaborationDashboard";
		...
		<div className="max-w-6xl mx-auto p-6">
			...
			<div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
				...
				<ol className="list-decimal list-inside text-blue-800 space-y-1">
					...
					<li>
						Try typing simultaneously in both tabs to see conflict resolution
					</li>
					<li>
						Go offline in one tab and continue editing - changes will sync when
						back online
					</li>
				</ol>
			</div>
			...
			<div className="mt-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
				...
				<ul className="list-disc list-inside text-gray-700 space-y-1">
					<li>
						<strong>Real-time Sync:</strong> Changes appear instantly across all
						connected clients
					</li>
					<li>
						<strong>Conflict Resolution:</strong> Y.js CRDT automatically merges
						concurrent edits
					</li>
					<li>
						<strong>User Presence:</strong> See who's actively editing the
						document
					</li>
					<li>
						<strong>Connection Management:</strong> Automatic reconnection with
						exponential backoff
					</li>
					<li>
						<strong>Performance Monitoring:</strong> Real-time sync statistics
						and metrics
					</li>
					<li>
						<strong>Enhanced Error Recovery:</strong> Robust error handling and
						retry logic
					</li>
					<li>
						<strong>Offline Support:</strong> Continue editing offline, sync
						when reconnected
					</li>
					<li>
						<strong>Error Handling:</strong> Graceful handling of network issues
						and sync errors
					</li>
					<li>
						<strong>Status Indicators:</strong> Visual feedback for sync status
						and connection state
					</li>
					<li>
						<strong>Local Persistence:</strong> Documents are saved locally via
						IndexedDB
					</li>
				</ul>
			</div>
			...
			<div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
				...
				<ul className="list-disc list-inside text-yellow-800 space-y-1">
					...
					<li>
						The status indicator shows current sync state (synced, syncing,
						error, offline)
					</li>
					<li>
						Red error messages will appear if sync fails - use the "Retry Sync"
						button
					</li>
					<li>
						Document changes are debounced (500ms) before sending to server
					</li>
