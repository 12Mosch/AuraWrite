...
export const CollaborativeEditingTest: React.FC = () => {
  const [testDocumentId, setTestDocumentId] = useState<Id<"documents"> | null>(null);
    ...
    const createTestDocument = async () => {
      ...
      try {
        const docId = await createDocument({
          ...
          content: JSON.stringify([{type: "paragraph", children: [{text: "Start typing to test collaboration..."}]}]),
          isPublic: false,
        });
  ...
  if (!testDocumentId) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-lg text-red-600">Failed to create test document. Please refresh the page.</div>
      </div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-4">
          Test real-time collaboration by typing in either editor below. 
          Changes should appear instantly in both editors.
        </p>
      ...
      {showDebugInfo && (
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          ...
          <div className="text-sm text-gray-700 space-y-1">
            <p><strong>Document ID:</strong> {testDocumentId}</p>
            <p><strong>Expected Behavior:</strong> Changes in one editor should appear in the other within 1-2 seconds</p>
            <p><strong>Check Console:</strong> Look for sync messages and any errors</p>
            <p><strong>Network Tab:</strong> Should see WebSocket connections and Convex API calls</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          <h4 className="font-semibold text-red-900 mb-2">❌ Potential Issues:</h4>
