...
import {
	ConvexErrorBoundary,
	withConvexErrorBoundary,
} from "../components/ConvexErrorBoundary";
import { DocumentHeader } from "../components/DocumentHeader";
import {
	useDocumentMetadata,
	useMultipleDocumentMetadata,
} from "../hooks/useDocumentMetadata";

/**
 * Component that uses useDocumentMetadata - wrapped with error boundary
 */
const DocumentMetadataDisplay: React.FC<{ documentId: Id<"documents"> }> = ({
	documentId,
}) => {
 ...
 */
const DocumentListDisplay: React.FC<{ documentIds: Id<"documents">[] }> = ({
	documentIds,
}) => {
	// This will throw errors that are caught by ConvexErrorBoundary
 ...
 */
const MutationExample: React.FC<{ documentId: Id<"documents"> }> = ({
	documentId,
}) => {
 ...
 */
const ActionExample: React.FC<{ documentId: Id<"documents"> }> = ({
	documentId,
}) => {
 ...
 */
const DocumentHeaderWithErrorBoundary = withConvexErrorBoundary(
	DocumentHeader,
	{
...
export const ConvexErrorHandlingExample: React.FC = () => {
	...
	const [documentId] = useState<Id<"documents">>(
		"example-doc-id" as Id<"documents">,
	);
		...
		<div className="max-w-4xl mx-auto p-6 space-y-8">
			<div>
				<h1 className="text-2xl font-bold mb-4">
					Convex Error Handling Examples
				</h1>
				<p className="text-gray-600 mb-8">
					This page demonstrates proper error handling patterns for Convex
			...
			<section>
				<h2 className="text-xl font-semibold mb-4">
					1. Query Error Handling (Error Boundaries)
				</h2>
			...
			<section>
				<h2 className="text-xl font-semibold mb-4">
					3. Mutation Error Handling (Try/Catch)
				</h2>
			...
			<section>
				<h2 className="text-xl font-semibold mb-4">
					4. Action Error Handling (Try/Catch)
				</h2>
			...
			<section>
				...
				<div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
					...
					<ul className="space-y-2 text-blue-700">
						<li>
							• <strong>Queries:</strong> Use Error Boundaries - errors are
							thrown during rendering
						</li>
						<li>
							• <strong>Mutations:</strong> Use try/catch or .catch() - errors
							are promise rejections
						</li>
						<li>
							• <strong>Actions:</strong> Use try/catch or .catch() - errors are
							promise rejections
						</li>
						<li>
							• <strong>Error Boundaries:</strong> Wrap components that use
							useQuery hooks
						</li>
						<li>
							• <strong>Granular Control:</strong> Use component-level error
							boundaries for specific handling
						</li>
					</ul>
				</div>
			</section>
